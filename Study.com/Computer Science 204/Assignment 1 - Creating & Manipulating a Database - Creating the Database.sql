...
-- Creates the new Borrower table
CREATE TABLE IF NOT EXISTS Borrower (
    ...
    -- Sets indexes for faster queries
    INDEX (BorrowId, ClientId, BookId, BorrowDate)
);

-- Creates the new Client table
CREATE TABLE IF NOT EXISTS Client (
	ClientID int PRIMARY KEY,
    -- First names normally shorter than last names
...
CREATE TABLE IF NOT EXISTS Book (
	...
	-- Sets indexes for faster queries
    Index (BookID, BookTitle, AuthorID, Genre)
);

-- Creates the new Author table
